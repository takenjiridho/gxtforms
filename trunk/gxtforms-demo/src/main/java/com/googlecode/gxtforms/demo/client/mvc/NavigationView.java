...
import com.googlecode.gxtforms.demo.client.model.Folder;
...
public class NavigationView extends View {
  ...
  protected void initialize() {
    model = (ExplorerModel) Registry.get(Application.MODEL);
